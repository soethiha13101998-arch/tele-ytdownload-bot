...
async def get_port_info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Geocoding: ဆိပ်ကမ်းနာမည်မှ Latitude / Longitude ယူရန်
    ...
    try:
        ...
        # Weather API: ရာသီဥတုနှင့် လေတိုက်နှုန်း ယူရန်
        ...
        response_text = (
            ...
            f"💡 *မှတ်ချက်:* လိုအပ်ပါက သက်ဆိုင်ရာ ဒေသန္တရ ဒီရေဇယား (Tide Table) နှင့် တွဲဖက်ကြည့်ရှုရန် အကြံပြုပါသည်။"
        )
